...
.segment "CODE"
REU_ALIASING_DETECT = REU_ALIASING_DETECT_PROC
REU_DETECT_SIZE		= REU_DETECT_SIZE_PROC
...
reu_probe_banks:
    ; ────────────────────────────────────────────────────────
    ; test for aliasing at each power-of-2 boundary
...
REU_BUF:	.res 256, $00	; phase 1 save buffer: REU_BUF[0..255]
