...
; ============================================================
REU_BASE        := $df00
REU_STATUS      := REU_BASE 	  ; Status  register  (read)
REU_COMMAND     := REU_BASE + $01 ; Command register  (write)
REU_C64_LO      := REU_BASE + $02 ; C64 base address  - low  byte
REU_C64_HI      := REU_BASE + $03 ; C64 base address  - high byte
REU_REU_LO      := REU_BASE + $04 ; REU base address  - low  byte
REU_REU_HI      := REU_BASE + $05 ; REU base address  - high byte
REU_REU_BANK    := REU_BASE + $06 ; REU bank number   (0-7 for 512KB)
REU_LEN_LO      := REU_BASE + $07 ; Transfer length   - low  byte
REU_LEN_HI      := REU_BASE + $08 ; Transfer length   - high byte
REU_INT_MASK    := REU_BASE + $09 ; Interrupt mask    register
REU_ADDR_CTRL   := REU_BASE + $0a ; Address control   register
