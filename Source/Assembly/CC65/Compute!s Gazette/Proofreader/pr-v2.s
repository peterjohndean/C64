...
;
; CC65
; cl65 -g -t c64 -C pr-v2.cfg -Ln pr-v2-vice.txt -m pr-v2-map.txt -l pr-v2-list.txt pr-v2.s -o pr-v2.bin

	.segment "LOADADDR"
    .word $0376     ; The PRG load address header
...
BREAK:	
		jsr $ddcd	; Points to BRK, why not use the BRK, plus not a notable routine!
