# c64librarytests - C64 Assembly Project
...
├── c64librarytests.prg       ← C64 executable
├── c64librarytests_lbl.txt   ← VICE monitor labels
└── c64librarytests_lst.txt   ← Assembly listing
```
...
│
└── c64librarytests/
    ├── c64librarytests.xcodeproj/
    │   └── xcshareddata/
    │       └── xcschemes/
    │           └── c64librarytests.xcscheme   ← pre-configured Run scheme
    │
    └── c64librarytests/         ← target subdirectory (source only)
...
├── c64librarytests.prg
├── c64librarytests_lbl.txt
└── c64librarytests_lst.txt
```
